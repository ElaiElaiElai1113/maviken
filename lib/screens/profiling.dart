...
final TextEditingController ratePayDay = TextEditingController();
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  // Only show this if the position is 'Office Staff'
                  if (_selectedEmployee?['positionID'] == 2)
                    Expanded(
                      flex: 3,
                      child: textField(ratePayDay, 'Rate Per Day', context,
                          enabled: true),
                    ),
                ],
              ),
